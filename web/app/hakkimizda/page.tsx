    ...
    <>
      ...
      <div className="container py-10 max-w-3xl">
        <nav className="text-sm text-muted-foreground mb-4">
          <Link href="/" className="hover:text-foreground">Ana Sayfa</Link> / <span>Hakkımızda</span>
        </nav>
        <h1 className="text-3xl md:text-4xl font-bold mb-2">Hakkımızda</h1>
        ...
        <div className="policy-content rounded-xl border bg-card p-6 md:p-8 shadow-sm">
          ...
          <p>
            ...
            <Link href="/editoryal-politika">Editoryal Politika</Link> sayfamıza,
            emsal karar verisinin kaynağı ve güncelleme sıklığı için{" "}
